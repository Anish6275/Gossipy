			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form action="authenticate.php" method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="uid" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>" placeholder="User ID">
					...
					<div class="contact100-form-checkbox m-l-4">
						<input class="input-checkbox100" id="ckb1" <?php if(isset($_COOKIE["member_login"])) { ?> checked <?php } ?> type="checkbox" name="remember-me">
