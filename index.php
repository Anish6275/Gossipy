...
<head>
    ...
    <meta name="keywords"
        content="php chat script, php ajax Chat,facebook similar chat, php mysql chat, chat script, facebook style chat script, gmail style chat script. fbchat, gmail chat, facebook style message inbox, facebook similar inbox, facebook like chat">
    <meta name="description"
        content="Wchat is a popular responsive php ajax inbox messaging (Chat) WebApp for websites, mobile apps and control panels.">

    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="frontEnd/assets/images/icon.ico">
    <title>Gossipy</title>
    <!-- Bootstrap Core CSS -->
    <link href="frontEnd/assets/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Animation CSS -->
    <link href="frontEnd/assets/css/animate.css" rel="stylesheet">
    <link href="frontEnd/assets/css/custom.css" rel="stylesheet" id="style">
    <!-- Theme light dark version CSS -->
    <link href="frontEnd/assets/css/style.css" rel="stylesheet">
    <link href="frontEnd/assets/css/style-light.css" id="maintheme" rel="stylesheet">
    <!-- color CSS you can use different color css from css/colors folder -->
    <!-- We have chosen the skin-blue (blue.css) for this starter
         page. However, you can choose any other skin from folder css / colors .
    -->
    <link href="frontEnd/assets/css/colors/green.css" id="theme" rel="stylesheet">
    <!-- Emoji One JS -->
    ...
    <script type="text/javascript">
        ...
        emojione.imagePathPNG = 'frontEnd/smiley/assets/png/';
        emojione.imagePathSVG = 'frontEnd/smiley/assets/svg/';
...
-->
            ...
            <div tabindex="-1" class="wchat two">
                                ...
                                <div class="chat-body">
                                    <div class="chat-main">
                                        <h2 class="chat-title" dir="auto"><span
                                                class="wchatellips personName"><?php echo $row['name']; ?></span></h2>
                                    </div>
                                </div>
                                <div class="wchat-chat-controls">
                                    <div class="menu menu-horizontal">
                                        ...
                                        <div class="menu-item right-side-toggle"><button
                                                class="icon ti-settings font-20" title="Attach"></button><span></span>
                                        </div>
                                    </div>
                                </div>
                            </header>
                ...
                <div tabindex="-1" id="main right" class="pane wchat-chat wchat-two chat-right-aside right"
                    ...
                    <header class="wchat-header wchat-chat-header top" data-user="">
                        ...
                        <div class="chat-body">
                            <div class="chat-main">
                                <h2 class="chat-title" dir="auto"><span class="wchatellips personName curName">Alpha</span>
                                </h2>
                            </div>
                            ...
                            <div class="menu menu-horizontal">
                                ...
                                <div class="mega-dropdown  pull-right"> <button
                                        ...
                                        aria-expanded="false"><span class="font-19"><i
                                                class="icon fa fa-paperclip"></i></span></button>
                                    <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown"
                                        ...
                                        <li class="col-sm-12 demo-box">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="white-box text-center bg-purple uploadFile"
                                                        id="uploadFile"><a href="#" class="text-white"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="white-box text-center bg-success uploadFile"><a href="#"
                                                            class="text-white" data-toggle="tooltip" title=""
                                ...
                                <div class="menu-item active dropdown pull-right">
                                    ...
                                    <ul class="dropdown-menu dropdown-user animated flipInY">
                                        ...
                                        <li><a href="javascript:void(0)"><i class="ti-wallet"></i> Email This Chat</a>
                                        </li>
                                        <li><a href="javascript:void(0)"><i class="icon-doc"></i> Save Chat</a></li>
                                    </ul>
                                    <!-- /.dropdown-user -->
                                </div>
                                <div class="menu-item right-side-toggle hidden-xs hidden"><button
                                        class="icon ti-settings font-20" title="Attach"></button><span></span></div>
                            </div>
                        </div>
                    </header>
                        ...
                        <div>
                            ...
                            <div class="wchat-chat-msgs wchat-chat-body lastTabIndex" tabindex="0">
                                ...
                                <div class="message-list">
                                    <div class="chat-list cbox" id="resultchat">
                                    ...
                                    <div class="smiley-panel">
                                        ...
                                        <ul class="nav customtab2 nav-tabs menu-tabs" role="tablist"
                                            ...
                                            <li role="presentation" class="menu-item"><a href="#activity"
                                                    ...
                                                    aria-expanded="false"><i class="ti-basketball"></i></a></li>
                                            ...
                                            <li role="presentation" class="menu-item"><a href="#objects"
                                                    ...
                                                    aria-expanded="false"><i class="ti-light-bulb"></i></a></li>
                                                    ...
                                                    <div class="smiley-panel-body">
                                                        <div class="emoji-people">
                                                            <span class="e1" id="1f600" data-shortname=":grinning:"
                                                                data-index="1" title="grinning face"
                                                                data-eid="735"><span
                                                            ...
                                                            <span class="e1" id="1f617" data-shortname=":kissing:"
                                                                data-index="15" title="kissing face"
                                                                data-eid="742"><span
                                                            ...
                                                            <span class="e1" id="263a" data-shortname=":relaxed:"
                                                                ...
                                                                data-eid="53"><span
                                                                    class="emojione emojione-263a"></span></span>
                                                            ...
                                                            <span class="e1" id="1f917" data-shortname=":hugging:"
                                                                data-index="20" title="hugging face"
                                                                data-eid="2079"><span
                                                            ...
                                                            <span class="e1" id="1f610" data-shortname=":neutral_face:"
                                                                data-index="22" title="neutral face"
                                                                data-eid="739"><span
                                                                    class="emojione emojione-1f610"></span></span>
                                                            <span class="e1" id="1f611"
                                                                data-shortname=":expressionless:" data-index="23"
                                                                title="expressionless face" data-eid="740"><span
                                                                    class="emojione emojione-1f611"></span></span>
                                                            <span class="e1" id="1f636" data-shortname=":no_mouth:"
                                                                data-index="24" title="face without mouth"
                                                                data-eid="752"><span
                                                            ...
                                                            <span class="e1" id="1f60f" data-shortname=":smirk:"
                                                                data-index="26" title="smirking face"
                                                                data-eid="637"><span
                                                            ...
                                                            <span class="e1" id="1f910" data-shortname=":zipper_mouth:"
                                                                data-index="30" title="zipper-mouth face"
                                                                data-eid="2082"><span
                                                            ...
                                                            <span class="e1" id="1f61b"
                                                                data-shortname=":stuck_out_tongue:" data-index="37"
                                                                title="face with stuck-out tongue" data-eid="744"><span
                                                            ...
                                                            <span class="e1" id="1f612" data-shortname=":unamused:"
                                                                data-index="41" title="unamused face"
                                                                data-eid="638"><span
                                                            ...
                                                            <span class="e1" id="1f61f" data-shortname=":worried:"
                                                                data-index="52" title="worried face"
                                                                data-eid="745"><span
                                                            ...
                                                            <span class="e1" id="1f62d" data-shortname=":sob:"
                                                                data-index="55" title="loudly crying face"
                                                                data-eid="662"><span
                                                            ...
                                                            <span class="e1" id="1f628" data-shortname=":fearful:"
                                                                data-index="58" title="fearful face"
                                                                data-eid="658"><span
                                                            ...
                                                            <span class="e1" id="1f633" data-shortname=":flushed:"
                                                                data-index="63" title="flushed face"
                                                                data-eid="666"><span
                                                            ...
                                                            <span class="e1" id="1f621" data-shortname=":rage:"
                                                                data-index="65" title="pouting face"
                                                                data-eid="653"><span
                                                            ...
                                                            <span class="e1" id="1f912"
                                                                data-shortname=":thermometer_face:" data-index="72"
                                                                title="face with thermometer" data-eid="2083"><span
                                                            ...
                                                            <span class="e1" id="1f922"
                                                                data-shortname=":nauseated_face:" data-index="74"
                                                                title="nauseated face" data-eid="2255"><span
                                                            ...
                                                            <span class="e1" id="1f479" data-shortname=":japanese_ogre:"
                                                                data-index="78" title="japanese ogre"
                                                                data-eid="440"><span
                                                                    class="emojione emojione-1f479"></span></span>
                                                            <span class="e1" id="1f47a"
                                                                data-shortname=":japanese_goblin:" data-index="79"
                                                                title="japanese goblin" data-eid="441"><span
                                                            ...
                                                            <span class="e1" id="1f63b"
                                                                data-shortname=":heart_eyes_cat:" data-index="88"
                                                            ...
                                                            <span class="e1" id="1f63f"
                                                                data-shortname=":crying_cat_face:" data-index="92"
                                                                title="crying cat face" data-eid="676"><span
                                                            ...
                                                            <span class="e1" id="1f466" data-tone="0"
                                                                data-shortname=":boy:" data-index="94" title="boy"
                                                                data-eid="423"><span
                                                            ...
                                                            <span class="e1" id="1f468" data-tone="0"
                                                                data-shortname=":man:" data-index="96" title="man"
                                                                data-eid="425"><span
                                                            ...
                                                            <span class="e1" id="1f46e" data-tone="0"
                                                                data-shortname=":cop:" data-index="102"
                                                                title="police officer" data-eid="429"><span
                                                                    class="emojione emojione-1f46e"></span></span>
                                                            <span class="e1" id="1f575" data-tone="0"
                                                                data-shortname=":spy:" data-index="103"
                                                                title="sleuth or spy" data-eid="1217"><span
                                                            ...
                                                            <span class="e1" id="1f471" data-tone="0"
                                                                data-shortname=":person_with_blond_hair:"
                                                                data-index="107" title="person with blond hair"
                                                                data-eid="432"><span
                                                            ...
                                                            <span class="e1" id="1f936" data-shortname=":mrs_claus:"
                                                                data-index="109" title="mother christmas"
                                                                data-eid="2262"><span
                                                            ...
                                                            <span class="e1" id="1f930"
                                                                data-shortname=":pregnant_woman:" data-index="114"
                                                                title="pregnant woman" data-eid="2265"><span
                                                            ...
                                                            <span class="e1" id="1f647" data-tone="0"
                                                                data-shortname=":bow:" data-index="122"
                                                                title="person bowing deeply" data-eid="680"><span
                                                            ...
                                                            <span class="e1" id="1f3c3" data-tone="0"
                                                                data-shortname=":runner:" data-index="128"
                                                                title="runner" data-eid="321"><span
                                                                    class="emojione emojione-1f3c3"></span></span>
                                                            <span class="e1" id="1f483" data-tone="0"
                                                                data-shortname=":dancer:" data-index="129"
                                                                title="dancer" data-eid="451"><span
                                                                    class="emojione emojione-1f483"></span></span>
                                                            <span class="e1" id="1f57a" data-shortname=":man_dancing:"
                                                                data-index="130" title="man dancing"
                                                                data-eid="2267"><span
                                                            ...
                                                            <span class="e1" id="1f46c"
                                                                data-shortname=":two_men_holding_hands:"
                                                                data-index="136" title="two men holding hands"
                                                                data-eid="826"><span
                                                            ...
                                                            <span class="e1" id="1f491"
                                                                data-shortname=":couple_with_heart:" data-index="141"
                                                                title="couple with heart" data-eid="477"><span
                                                            ...
                                                            <span class="e1" id="270c" data-tone="0"
                                                                data-shortname=":v:" data-index="167"
                                                                title="victory hand" data-eid="96"><span
                                                                    class="emojione emojione-270c"></span></span>
                                                            <span class="e1" id="1f91e"
                                                                data-shortname=":fingers_crossed:" data-index="168"
                                                            ...
                                                            <span class="e1" id="270a" data-tone="0"
                                                                data-shortname=":fist:" data-index="177"
                                                                title="raised fist" data-eid="94"><span
                                                            ...
                                                            <span class="e1" id="1f91b"
                                                                data-shortname=":left_facing_fist:" data-index="179"
                                                                title="left-facing fist" data-eid="2270"><span
                                                                    class="emojione emojione-1f91b"></span></span>
                                                            <span class="e1" id="1f91c"
                                                                data-shortname=":right_facing_fist:" data-index="180"
                                                                title="right-facing fist" data-eid="2271"><span
                                                            ...
                                                            <span class="e1" id="1f442" data-tone="0"
                                                                data-shortname=":ear:" data-index="190" title="ear"
                                                                data-eid="388"><span
                                                            ...
                                                            <span class="e1" id="1f576"
                                                                data-shortname=":dark_sunglasses:" data-index="200"
                                                                title="dark sunglasses" data-eid="1127"><span
                                                            ...
                                                            <span class="e1" id="1f45a"
                                                                data-shortname=":womans_clothes:" data-index="207"
                                                                title="womans clothes" data-eid="412"><span
                                                            ...
                                                            <span class="e1" id="1f392"
                                                                data-shortname=":school_satchel:" data-index="211"
                                                                title="school satchel" data-eid="284"><span
                                                            ...
                                                            <span class="e1" id="1f462" data-shortname=":boot:"
                                                                data-index="216" title="womans boots"
                                                                data-eid="420"><span
                                                            ...
                                                            <span class="e1" id="26d1"
                                                                data-shortname=":helmet_with_cross:" data-index="221"
                                                                title="helmet with white cross" data-eid="1682"><span
                                                            ...
                                                            <span class="e1" id="1f302"
                                                                data-shortname=":closed_umbrella:" data-index="224"
                                                                title="closed umbrella" data-eid="175"><span
                                                    ...
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-nature">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4a8"
                                                                data-shortname=":dash:" data-index="5"
                                                                title="dash symbol" data-eid="545"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f98d"
                                                                data-shortname=":gorilla:" data-index="8"
                                                                title="gorilla" data-eid="2283"><span
                                                                    class="emojione emojione-1f98d"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f436"
                                                                data-shortname=":dog:" data-index="9" title="dog face"
                                                                data-eid="378"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f43a"
                                                                data-shortname=":wolf:" data-index="12"
                                                                title="wolf face" data-eid="382"><span
                                                                    class="emojione emojione-1f43a"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f98a"
                                                                data-shortname=":fox:" data-index="13" title="fox face"
                                                                data-eid="2280"><span
                                                                    class="emojione emojione-1f98a"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f431"
                                                                data-shortname=":cat:" data-index="14" title="cat face"
                                                                data-eid="373"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f406"
                                                                data-shortname=":leopard:" data-index="19"
                                                                title="leopard" data-eid="813"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f40e"
                                                                data-shortname=":racehorse:" data-index="21"
                                                                title="horse" data-eid="344"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f42e"
                                                                data-shortname=":cow:" data-index="24" title="cow face"
                                                                data-eid="370"><span
                                                                    class="emojione emojione-1f42e"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f402"
                                                                data-shortname=":ox:" data-index="25" title="ox"
                                                                data-eid="809"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f437"
                                                                data-shortname=":pig:" data-index="28" title="pig face"
                                                                data-eid="379"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f40f"
                                                                data-shortname=":ram:" data-index="32" title="ram"
                                                                data-eid="819"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f400"
                                                                data-shortname=":rat:" data-index="41" title="rat"
                                                                data-eid="807"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f407"
                                                                data-shortname=":rabbit2:" data-index="44"
                                                                title="rabbit" data-eid="814"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f987"
                                                                data-shortname=":bat:" data-index="46" title="bat"
                                                                data-eid="2277"><span
                                                                    class="emojione emojione-1f987"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f43b"
                                                                data-shortname=":bear:" data-index="47"
                                                                title="bear face" data-eid="383"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f43e"
                                                                data-shortname=":feet:" data-index="50"
                                                                title="paw prints" data-eid="386"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f414"
                                                                data-shortname=":chicken:" data-index="52"
                                                                title="chicken" data-eid="347"><span
                                                                    class="emojione emojione-1f414"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f413"
                                                                data-shortname=":rooster:" data-index="53"
                                                                title="rooster" data-eid="821"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f427"
                                                                data-shortname=":penguin:" data-index="58"
                                                                title="penguin" data-eid="364"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f989"
                                                                data-shortname=":owl:" data-index="62" title="owl"
                                                                data-eid="2279"><span
                                                                    class="emojione emojione-1f989"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f438"
                                                                data-shortname=":frog:" data-index="63"
                                                                title="frog face" data-eid="380"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f42c"
                                                                data-shortname=":dolphin:" data-index="72"
                                                                title="dolphin" data-eid="368"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f419"
                                                                data-shortname=":octopus:" data-index="77"
                                                                title="octopus" data-eid="350"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f41b"
                                                                data-shortname=":bug:" data-index="84" title="bug"
                                                                data-eid="352"><span
                                                                    class="emojione emojione-1f41b"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f41c"
                                                                data-shortname=":ant:" data-index="85" title="ant"
                                                                data-eid="353"><span
                                                                    class="emojione emojione-1f41c"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f41d"
                                                                data-shortname=":bee:" data-index="86" title="honeybee"
                                                                data-eid="354"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f490"
                                                                data-shortname=":bouquet:" data-index="91"
                                                                title="bouquet" data-eid="475"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3f5"
                                                                data-shortname=":rosette:" data-index="93"
                                                                title="rosette" data-eid="1104"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f33c"
                                                                data-shortname=":blossom:" data-index="98"
                                                                title="blossom" data-eid="204"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f335"
                                                                data-shortname=":cactus:" data-index="104"
                                                                title="cactus" data-eid="198"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2b50"
                                                                data-shortname=":star:" data-index="132"
                                                                title="white medium star" data-eid="125"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2601"
                                                                ...
                                                                data-eid="47"><span
                                                                    class="emojione emojione-2601"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f324"
                                                                ...
                                                                data-index="137" title="white sun with small cloud"
                                                                data-eid="1693"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f32b"
                                                                data-shortname=":fog:" data-index="144" title="fog"
                                                                data-eid="1088"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="26a1"
                                                                data-shortname=":zap:" data-index="148"
                                                                title="high voltage sign" data-eid="75"><span
                                                                    class="emojione emojione-26a1"></span></span>
                                                    ...
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-food">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f34e"
                                                                data-shortname=":apple:" data-index="8"
                                                                title="red apple" data-eid="221"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f95d"
                                                                data-shortname=":kiwi:" data-index="14"
                                                                title="kiwifruit" data-eid="2323"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f951"
                                                                data-shortname=":avocado:" data-index="16"
                                                                title="avocado" data-eid="2288"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f95c"
                                                                data-shortname=":peanuts:" data-index="23"
                                                                title="peanuts" data-eid="2322"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f32d"
                                                                data-shortname=":hotdog:" data-index="35"
                                                                title="hot dog" data-eid="2093"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f32f"
                                                                data-shortname=":burrito:" data-index="37"
                                                                title="burrito" data-eid="2095"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f95a"
                                                                data-shortname=":egg:" data-index="39" title="egg"
                                                                data-eid="2320"><span
                                                                    class="emojione emojione-1f95a"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f373"
                                                                data-shortname=":cooking:" data-index="40"
                                                                title="cooking" data-eid="257"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f37f"
                                                                data-shortname=":popcorn:" data-index="44"
                                                                title="popcorn" data-eid="2096"><span
                                                                    class="emojione emojione-1f37f"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f371"
                                                                data-shortname=":bento:" data-index="45"
                                                                title="bento box" data-eid="255"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f370"
                                                                data-shortname=":cake:" data-index="64"
                                                                title="shortcake" data-eid="254"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f36e"
                                                                data-shortname=":custard:" data-index="68"
                                                                title="custard" data-eid="252"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f375"
                                                                data-shortname=":tea:" data-index="73"
                                                                title="teacup without handle" data-eid="259"><span
                                                    ...
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-activity">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6a3" data-tone="0"
                                                                data-shortname=":rowboat:" data-index="9"
                                                                title="rowboat" data-eid="771"><span
                                                                    class="emojione emojione-1f6a3"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f3ca" data-tone="0"
                                                                data-shortname=":swimmer:" data-index="10"
                                                                title="swimmer" data-eid="325"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3a8"
                                                                data-shortname=":art:" data-index="22"
                                                                title="artist palette" data-eid="294"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3b1"
                                                                data-shortname=":8ball:" data-index="41"
                                                                title="billiards" data-eid="303"><span
                                                                    class="emojione emojione-1f3b1"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f3b3"
                                                                data-shortname=":bowling:" data-index="42"
                                                                title="bowling" data-eid="305"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3af"
                                                                data-shortname=":dart:" data-index="51"
                                                                title="direct hit" data-eid="301"><span
                                                                    class="emojione emojione-1f3af"></span></span>
                                                            <span class="e1" tabindex="-1" id="26f3"
                                                                data-shortname=":golf:" data-index="52"
                                                                title="flag in hole" data-eid="86"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3bd"
                                                                data-shortname=":running_shirt_with_sash:"
                                                                data-index="55" title="running shirt with sash"
                                                                data-eid="315"><span
                                                                    class="emojione emojione-1f3bd"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f3bf"
                                                                data-shortname=":ski:" data-index="56"
                                                                title="ski and ski boot" data-eid="317"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3ba"
                                                                data-shortname=":trumpet:" data-index="65"
                                                                title="trumpet" data-eid="312"><span
                                                    ...
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-travel">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f30b"
                                                                data-shortname=":volcano:" data-index="6"
                                                                title="volcano" data-eid="184"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3d5"
                                                                data-shortname=":camping:" data-index="8"
                                                                title="camping" data-eid="1235"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3df"
                                                                data-shortname=":stadium:" data-index="13"
                                                                title="stadium" data-eid="1245"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3ed"
                                                                data-shortname=":factory:" data-index="31"
                                                                title="factory" data-eid="338"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f492"
                                                                data-shortname=":wedding:" data-index="34"
                                                                title="wedding" data-eid="479"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="26ea"
                                                                ...
                                                                data-eid="84"><span
                                                                    class="emojione emojione-26ea"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="26fa"
                                                                data-shortname=":tent:" data-index="43" title="tent"
                                                                data-eid="88"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f304"
                                                                ...
                                                                data-index="46" title="sunrise over mountains"
                                                                data-eid="177"><span
                                                                    class="emojione emojione-1f304"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f305"
                                                                data-shortname=":sunrise:" data-index="47"
                                                                title="sunrise" data-eid="178"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f689"
                                                                data-shortname=":station:" data-index="62"
                                                                title="station" data-eid="694"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f68b"
                                                                data-shortname=":train:" data-index="66"
                                                                title="tram car" data-eid="862"><span
                                                                    class="emojione emojione-1f68b"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f68c"
                                                                data-shortname=":bus:" data-index="67" title="bus"
                                                                data-eid="695"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f690"
                                                                data-shortname=":minibus:" data-index="70"
                                                                title="minibus" data-eid="760"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f69c"
                                                                data-shortname=":tractor:" data-index="82"
                                                                title="tractor" data-eid="765"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6f4"
                                                                data-shortname=":scooter:" data-index="84"
                                                                title="scooter" data-eid="2302"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6a6"
                                                                ...
                                                                data-index="92" title="vertical traffic light"
                                                                data-eid="772"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2693"
                                                                ...
                                                                data-eid="73"><span
                                                                    class="emojione emojione-2693"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f680"
                                                                data-shortname=":rocket:" data-index="111"
                                                                title="rocket" data-eid="689"><span
                                                ...
                                                <span>
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-objects">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f48e"
                                                                data-shortname=":gem:" data-index="7" title="gem stone"
                                                                data-eid="471"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3fa"
                                                                data-shortname=":amphora:" data-index="9"
                                                                title="amphora" data-eid="2099"><span
                                                                    class="emojione emojione-1f3fa"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f5fa"
                                                                data-shortname=":map:" data-index="10" title="world map"
                                                                data-eid="1203"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6cc"
                                                                data-shortname=":sleeping_accommodation:"
                                                                data-index="15" title="sleeping accommodation"
                                                                data-eid="1209"><span
                                                                    class="emojione emojione-1f6cc"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f6cf"
                                                                data-shortname=":bed:" data-index="16" title="bed"
                                                                data-eid="1249"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6c1"
                                                                data-shortname=":bathtub:" data-index="20"
                                                                title="bathtub" data-eid="783"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="23f3"
                                                                data-shortname=":hourglass_flowing_sand:"
                                                                data-index="22" title="hourglass with flowing sand"
                                                                data-eid="36"><span
                                                                    class="emojione emojione-23f3"></span></span>
                                                            <span class="e1" tabindex="-1" id="231a"
                                                                data-shortname=":watch:" data-index="23" title="watch"
                                                                data-eid="29"><span
                                                                    class="emojione emojione-231a"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f388"
                                                                data-shortname=":balloon:" data-index="30"
                                                                title="balloon" data-eid="274"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4e0"
                                                                data-shortname=":fax:" data-index="49"
                                                                title="fax machine" data-eid="481"><span
                                                                    class="emojione emojione-1f4e0"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f50b"
                                                                data-shortname=":battery:" data-index="50"
                                                                title="battery" data-eid="520"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f5a8"
                                                                data-shortname=":printer:" data-index="54"
                                                                title="printer" data-eid="1147"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4bf"
                                                                data-shortname=":cd:" data-index="60"
                                                                title="optical disc" data-eid="599"><span
                                                                    class="emojione emojione-1f4bf"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f4c0"
                                                                data-shortname=":dvd:" data-index="61" title="dvd"
                                                                data-eid="601"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4fa"
                                                                data-shortname=":tv:" data-index="65" title="television"
                                                                data-eid="513"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4fc"
                                                                data-shortname=":vhs:" data-index="69"
                                                                title="videocassette" data-eid="516"><span
                                                                    class="emojione emojione-1f4fc"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f50d"
                                                                data-shortname=":mag:" data-index="70"
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4d6"
                                                                data-shortname=":book:" data-index="81"
                                                                title="open book" data-eid="462"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4b4"
                                                                data-shortname=":yen:" data-index="97"
                                                                title="banknote with yen sign" data-eid="575"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="270f"
                                                                data-shortname=":pencil2:" data-index="116"
                                                                title="pencil" data-eid="97"><span
                                                                    class="emojione emojione-270f"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4c5"
                                                                data-shortname=":date:" data-index="126"
                                                                title="calendar" data-eid="616"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f511"
                                                                data-shortname=":key:" data-index="149" title="key"
                                                                data-eid="529"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f528"
                                                                data-shortname=":hammer:" data-index="151"
                                                                title="hammer" data-eid="563"><span
                                                                    class="emojione emojione-1f528"></span></span>
                                                            <span class="e1" tabindex="-1" id="26cf"
                                                                data-shortname=":pick:" data-index="152" title="pick"
                                                                data-eid="1681"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f52b"
                                                                data-shortname=":gun:" data-index="157" title="pistol"
                                                                data-eid="567"><span
                                                                    class="emojione emojione-1f52b"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f6e1"
                                                                data-shortname=":shield:" data-index="158"
                                                                title="shield" data-eid="1211"><span
                                                                    class="emojione emojione-1f6e1"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f527"
                                                                data-shortname=":wrench:" data-index="159"
                                                                title="wrench" data-eid="561"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2699"
                                                                data-shortname=":gear:" data-index="161" title="gear"
                                                                data-eid="1675"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2696"
                                                                data-shortname=":scales:" data-index="164"
                                                                title="scales" data-eid="1673"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="26d3"
                                                                data-shortname=":chains:" data-index="166"
                                                                title="chains" data-eid="1683"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="26b0"
                                                                data-shortname=":coffin:" data-index="170"
                                                                title="coffin" data-eid="1678"><span
                                                                    class="emojione emojione-26b0"></span></span>
                                                            <span class="e1" tabindex="-1" id="26b1"
                                                                data-shortname=":urn:" data-index="171"
                                                                title="funeral urn" data-eid="1679"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6e2"
                                                                data-shortname=":oil:" data-index="173" title="oil drum"
                                                                data-eid="1212"><span
                                                    ...
                                                    <div class="smiley-panel-body" style="transform: translateX(0px);">
                                                        <div class="emoji-symbols">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f300"
                                                                data-shortname=":cyclone:" data-index="53"
                                                                title="cyclone" data-eid="173"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f508"
                                                                data-shortname=":speaker:" data-index="62"
                                                                title="speaker" data-eid="861"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3e7"
                                                                data-shortname=":atm:" data-index="74"
                                                                title="automated teller machine" data-eid="332"><span
                                                                    class="emojione emojione-1f3e7"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f6ae"
                                                                data-shortname=":put_litter_in_its_place:"
                                                                data-index="75" title="put litter in its place symbol"
                                                                data-eid="773"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6be"
                                                                data-shortname=":wc:" data-index="82"
                                                                title="water closet" data-eid="721"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f6c3"
                                                                data-shortname=":customs:" data-index="84"
                                                                title="customs" data-eid="785"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="21a9"
                                                                ...
                                                                data-eid="27"><span
                                                                    class="emojione emojione-21a9"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f51a"
                                                                data-shortname=":end:" data-index="117"
                                                                title="end with leftwards arrow above"
                                                                data-eid="541"><span
                                                                    class="emojione emojione-1f51a"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f51b"
                                                                data-shortname=":on:" data-index="118"
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f51d"
                                                                data-shortname=":top:" data-index="120"
                                                            ...
                                                            <span class="e1" tabindex="-1" id="269b"
                                                                data-shortname=":atom:" data-index="122"
                                                                title="atom symbol" data-eid="1676"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2648"
                                                                ...
                                                                data-eid="54"><span
                                                                    class="emojione emojione-2648"></span></span>
                                                            <span class="e1" tabindex="-1" id="2649"
                                                                data-shortname=":taurus:" data-index="134"
                                                                title="taurus" data-eid="55"><span
                                                                    class="emojione emojione-2649"></span></span>
                                                            <span class="e1" tabindex="-1" id="264a"
                                                                data-shortname=":gemini:" data-index="135"
                                                                title="gemini" data-eid="56"><span
                                                                    class="emojione emojione-264a"></span></span>
                                                            <span class="e1" tabindex="-1" id="264b"
                                                                data-shortname=":cancer:" data-index="136"
                                                                title="cancer" data-eid="57"><span
                                                                    class="emojione emojione-264b"></span></span>
                                                            <span class="e1" tabindex="-1" id="264c"
                                                                data-shortname=":leo:" data-index="137" title="leo"
                                                                data-eid="58"><span
                                                                    class="emojione emojione-264c"></span></span>
                                                            <span class="e1" tabindex="-1" id="264d"
                                                                data-shortname=":virgo:" data-index="138" title="virgo"
                                                                data-eid="59"><span
                                                                    class="emojione emojione-264d"></span></span>
                                                            <span class="e1" tabindex="-1" id="264e"
                                                                data-shortname=":libra:" data-index="139" title="libra"
                                                                data-eid="60"><span
                                                                    class="emojione emojione-264e"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2653"
                                                                data-shortname=":pisces:" data-index="144"
                                                                title="pisces" data-eid="65"><span
                                                                    class="emojione emojione-2653"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="23e9"
                                                                ...
                                                                data-eid="31"><span
                                                                    class="emojione emojione-23e9"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="23eb"
                                                                ...
                                                                data-eid="33"><span
                                                                    class="emojione emojione-23eb"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f3a6"
                                                                data-shortname=":cinema:" data-index="164"
                                                                title="cinema" data-eid="292"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="267b"
                                                                ...
                                                                data-eid="71"><span
                                                                    class="emojione emojione-267b"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2b55"
                                                                data-shortname=":o:" data-index="175"
                                                                title="heavy large circle" data-eid="126"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2611"
                                                                ...
                                                                data-index="177" title="ballot box with check"
                                                                data-eid="49"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2716"
                                                                ...
                                                                data-index="179" title="heavy multiplication x"
                                                                data-eid="100"><span
                                                                    class="emojione emojione-2716"></span></span>
                                                            <span class="e1" tabindex="-1" id="274c"
                                                                data-shortname=":x:" data-index="180" title="cross mark"
                                                                data-eid="106"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="2122"
                                                                data-shortname=":tm:" data-index="200"
                                                                title="trade mark sign" data-eid="19"><span
                                                                    class="emojione emojione-2122"></span></span>
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f4af"
                                                                data-shortname=":100:" data-index="214"
                                                                title="hundred points symbol" data-eid="562"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f524"
                                                                data-shortname=":abc:" data-index="219"
                                                                title="input symbol for latin letters"
                                                                data-eid="557"><span
                                                                    class="emojione emojione-1f524"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f170"
                                                                data-shortname=":a:" data-index="220"
                                                                title="negative squared latin capital letter a"
                                                                data-eid="133"><span
                                                                    class="emojione emojione-1f170"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f18e"
                                                                data-shortname=":ab:" data-index="221"
                                                                title="negative squared ab" data-eid="137"><span
                                                                    class="emojione emojione-1f18e"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f171"
                                                                data-shortname=":b:" data-index="222"
                                                                title="negative squared latin capital letter b"
                                                                data-eid="134"><span
                                                                    class="emojione emojione-1f171"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f191"
                                                                data-shortname=":cl:" data-index="223"
                                                                title="squared cl" data-eid="138"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f194"
                                                                data-shortname=":id:" data-index="227"
                                                                title="squared id" data-eid="141"><span
                                                                    class="emojione emojione-1f194"></span></span>
                                                            <span class="e1" tabindex="-1" id="24c2"
                                                                data-shortname=":m:" data-index="228"
                                                                title="circled latin capital letter m"
                                                                data-eid="37"><span
                                                                    class="emojione emojione-24c2"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f195"
                                                                data-shortname=":new:" data-index="229"
                                                                title="squared new" data-eid="142"><span
                                                                    class="emojione emojione-1f195"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f196"
                                                                data-shortname=":ng:" data-index="230"
                                                                title="squared ng" data-eid="143"><span
                                                                    class="emojione emojione-1f196"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f17e"
                                                                data-shortname=":o2:" data-index="231"
                                                                title="negative squared latin capital letter o"
                                                                data-eid="135"><span
                                                                    class="emojione emojione-1f17e"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f197"
                                                                data-shortname=":ok:" data-index="232"
                                                                title="squared ok" data-eid="144"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f198"
                                                                data-shortname=":sos:" data-index="234"
                                                                title="squared sos" data-eid="145"><span
                                                                    class="emojione emojione-1f198"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f199"
                                                                data-shortname=":up:" data-index="235"
                                                                title="squared up with exclamation mark"
                                                                data-eid="146"><span
                                                                    class="emojione emojione-1f199"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f19a"
                                                                data-shortname=":vs:" data-index="236"
                                                                title="squared vs" data-eid="147"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f202"
                                                                data-shortname=":sa:" data-index="238"
                                                                title="squared katakana sa" data-eid="159"><span
                                                    ...
                                                    <div class="smiley-panel-body" id="emoji-gallery"
                                                        ...
                                                        <div class="emoji-flags">
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e6-1f1e9"
                                                                data-shortname=":flag_ad:" data-index="2"
                                                                title="andorra" data-eid="867"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e6-1f1ee"
                                                                data-shortname=":flag_ai:" data-index="6"
                                                                title="anguilla" data-eid="1070"><span
                                                                    class="emojione emojione-1f1e6-1f1ee"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e6-1f1f1"
                                                                data-shortname=":flag_al:" data-index="7"
                                                                title="albania" data-eid="865"><span
                                                                    class="emojione emojione-1f1e6-1f1f1"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e6-1f1f2"
                                                                data-shortname=":flag_am:" data-index="8"
                                                                title="armenia" data-eid="871"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e6-1f1f9"
                                                                data-shortname=":flag_at:" data-index="13"
                                                                title="austria" data-eid="873"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1ea"
                                                                data-shortname=":flag_be:" data-index="21"
                                                                title="belgium" data-eid="880"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1ed"
                                                                data-shortname=":flag_bh:" data-index="24"
                                                                title="bahrain" data-eid="876"><span
                                                                    class="emojione emojione-1f1e7-1f1ed"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1ee"
                                                                data-shortname=":flag_bi:" data-index="25"
                                                                title="burundi" data-eid="891"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1f2"
                                                                data-shortname=":flag_bm:" data-index="28"
                                                                title="bermuda" data-eid="1052"><span
                                                                    class="emojione emojione-1f1e7-1f1f2"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1f3"
                                                                data-shortname=":flag_bn:" data-index="29"
                                                                title="brunei" data-eid="888"><span
                                                                    class="emojione emojione-1f1e7-1f1f3"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1f4"
                                                                data-shortname=":flag_bo:" data-index="30"
                                                                title="bolivia" data-eid="884"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1f7"
                                                                data-shortname=":flag_br:" data-index="32"
                                                                title="brazil" data-eid="887"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1f9"
                                                                data-shortname=":flag_bt:" data-index="34"
                                                                title="bhutan" data-eid="883"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1fe"
                                                                data-shortname=":flag_by:" data-index="37"
                                                                title="belarus" data-eid="879"><span
                                                                    class="emojione emojione-1f1e7-1f1fe"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e7-1f1ff"
                                                                data-shortname=":flag_bz:" data-index="38"
                                                                title="belize" data-eid="881"><span
                                                                    class="emojione emojione-1f1e7-1f1ff"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1e8-1f1e6"
                                                                data-shortname=":flag_ca:" data-index="39"
                                                                title="canada" data-eid="894"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e8-1f1fe"
                                                                data-shortname=":flag_cy:" data-index="57"
                                                                title="cyprus" data-eid="905"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e9-1f1ea"
                                                                data-shortname=":flag_de:" data-index="59"
                                                                title="germany" data-eid="149"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e9-1f1f0"
                                                                data-shortname=":flag_dk:" data-index="62"
                                                                title="denmark" data-eid="908"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1e9-1f1ff"
                                                                data-shortname=":flag_dz:" data-index="65"
                                                                title="algeria" data-eid="866"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ea-1f1e8"
                                                                data-shortname=":flag_ec:" data-index="67"
                                                                title="ecuador" data-eid="913"><span
                                                                    class="emojione emojione-1f1ea-1f1e8"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1ea-1f1ea"
                                                                data-shortname=":flag_ee:" data-index="68"
                                                                title="estonia" data-eid="918"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ea-1f1f7"
                                                                data-shortname=":flag_er:" data-index="71"
                                                                title="eritrea" data-eid="917"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1eb-1f1ee"
                                                                data-shortname=":flag_fi:" data-index="75"
                                                                title="finland" data-eid="921"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1eb-1f1f7"
                                                                data-shortname=":flag_fr:" data-index="80"
                                                                title="france" data-eid="151"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ec-1f1e9"
                                                                data-shortname=":flag_gd:" data-index="83"
                                                                title="grenada" data-eid="927"><span
                                                                    class="emojione emojione-1f1ec-1f1e9"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1ec-1f1ea"
                                                                data-shortname=":flag_ge:" data-index="84"
                                                                title="georgia" data-eid="924"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ec-1f1f3"
                                                                data-shortname=":flag_gn:" data-index="91"
                                                                title="guinea" data-eid="929"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ec-1f1f7"
                                                                data-shortname=":flag_gr:" data-index="94"
                                                                title="greece" data-eid="926"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ec-1f1fe"
                                                                data-shortname=":flag_gy:" data-index="99"
                                                                title="guyana" data-eid="931"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ed-1f1f9"
                                                                data-shortname=":flag_ht:" data-index="104"
                                                                title="haiti" data-eid="932"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ee-1f1f1"
                                                                data-shortname=":flag_il:" data-index="109"
                                                                title="israel" data-eid="941"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ee-1f1f3"
                                                                data-shortname=":flag_in:" data-index="111"
                                                                title="india" data-eid="936"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ee-1f1f9"
                                                                data-shortname=":flag_it:" data-index="116"
                                                                title="italy" data-eid="153"><span
                                                                    class="emojione emojione-1f1ee-1f1f9"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1ef-1f1ea"
                                                                data-shortname=":flag_je:" data-index="117"
                                                                title="jersey" data-eid="1069"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ef-1f1f4"
                                                                data-shortname=":flag_jo:" data-index="119"
                                                                title="jordan" data-eid="943"><span
                                                                    class="emojione emojione-1f1ef-1f1f4"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1ef-1f1f5"
                                                                data-shortname=":flag_jp:" data-index="120"
                                                                title="japan" data-eid="154"><span
                                                                    class="emojione emojione-1f1ef-1f1f5"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f0-1f1ea"
                                                                data-shortname=":flag_ke:" data-index="121"
                                                                title="kenya" data-eid="945"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f0-1f1f7"
                                                                data-shortname=":flag_kr:" data-index="128"
                                                                title="korea" data-eid="155"><span
                                                                    class="emojione emojione-1f1f0-1f1f7"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f0-1f1fc"
                                                                data-shortname=":flag_kw:" data-index="129"
                                                                title="kuwait" data-eid="948"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f1-1f1fb"
                                                                data-shortname=":flag_lv:" data-index="141"
                                                                title="latvia" data-eid="951"><span
                                                                    class="emojione emojione-1f1f1-1f1fb"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f1-1f1fe"
                                                                data-shortname=":flag_ly:" data-index="142"
                                                                title="libya" data-eid="955"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f2-1f1e8"
                                                                data-shortname=":flag_mc:" data-index="144"
                                                                title="monaco" data-eid="972"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f2-1f1f4"
                                                                data-shortname=":flag_mo:" data-index="154"
                                                                title="macau" data-eid="1066"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f2-1f1f9"
                                                                data-shortname=":flag_mt:" data-index="159"
                                                                title="malta" data-eid="965"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f2-1f1fc"
                                                                data-shortname=":flag_mw:" data-index="162"
                                                                title="malawi" data-eid="961"><span
                                                                    class="emojione emojione-1f1f2-1f1fc"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f2-1f1fd"
                                                                data-shortname=":flag_mx:" data-index="163"
                                                                title="mexico" data-eid="969"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f3-1f1ea"
                                                                data-shortname=":flag_ne:" data-index="168"
                                                                title="niger" data-eid="984"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f3-1f1f4"
                                                                data-shortname=":flag_no:" data-index="173"
                                                                title="norway" data-eid="987"><span
                                                                    class="emojione emojione-1f1f3-1f1f4"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f3-1f1f5"
                                                                data-shortname=":flag_np:" data-index="174"
                                                                title="nepal" data-eid="980"><span
                                                                    class="emojione emojione-1f1f3-1f1f5"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f3-1f1f7"
                                                                data-shortname=":flag_nr:" data-index="175"
                                                                title="nauru" data-eid="979"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f5-1f1e6"
                                                                data-shortname=":flag_pa:" data-index="179"
                                                                title="panama" data-eid="991"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f5-1f1f1"
                                                                data-shortname=":flag_pl:" data-index="185"
                                                                title="poland" data-eid="996"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f5-1f1fc"
                                                                data-shortname=":flag_pw:" data-index="191"
                                                                title="palau" data-eid="990"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f6-1f1e6"
                                                                data-shortname=":flag_qa:" data-index="193"
                                                                title="qatar" data-eid="998"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f7-1f1f8"
                                                                data-shortname=":flag_rs:" data-index="196"
                                                                title="serbia" data-eid="1011"><span
                                                                    class="emojione emojione-1f1f7-1f1f8"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f7-1f1fa"
                                                                data-shortname=":flag_ru:" data-index="197"
                                                                title="russia" data-eid="157"><span
                                                                    class="emojione emojione-1f1f7-1f1fa"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f7-1f1fc"
                                                                data-shortname=":flag_rw:" data-index="198"
                                                                title="rwanda" data-eid="1002"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f8-1f1e9"
                                                                data-shortname=":flag_sd:" data-index="202"
                                                                title="sudan" data-eid="1021"><span
                                                                    class="emojione emojione-1f1f8-1f1e9"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f8-1f1ea"
                                                                data-shortname=":flag_se:" data-index="203"
                                                                title="sweden" data-eid="1024"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f8-1f1fe"
                                                                data-shortname=":flag_sy:" data-index="218"
                                                                title="syria" data-eid="1026"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f9-1f1f4"
                                                                data-shortname=":flag_to:" data-index="231"
                                                                title="tonga" data-eid="1031"><span
                                                                    class="emojione emojione-1f1f9-1f1f4"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1f9-1f1f7"
                                                                data-shortname=":flag_tr:" data-index="232"
                                                                title="turkey" data-eid="1034"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1f9-1f1fb"
                                                                data-shortname=":flag_tv:" data-index="234"
                                                                title="tuvalu" data-eid="1036"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1fa-1f1ec"
                                                                data-shortname=":flag_ug:" data-index="238"
                                                                title="uganda" data-eid="1037"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1fc-1f1f8"
                                                                data-shortname=":flag_ws:" data-index="251"
                                                                title="samoa" data-eid="1006"><span
                                                                    class="emojione emojione-1f1fc-1f1f8"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1fd-1f1f0"
                                                                data-shortname=":flag_xk:" data-index="252"
                                                                title="kosovo" data-eid="947"><span
                                                                    class="emojione emojione-1f1fd-1f1f0"></span></span>
                                                            <span class="e1" tabindex="-1" id="1f1fe-1f1ea"
                                                                data-shortname=":flag_ye:" data-index="253"
                                                                title="yemen" data-eid="1047"><span
                                                            ...
                                                            <span class="e1" tabindex="-1" id="1f1ff-1f1f2"
                                                                data-shortname=":flag_zm:" data-index="256"
                                                                title="zambia" data-eid="1048"><span
    ...
    <div id="lightbox" style="display: none;">
        <p>
            <img src="frontEnd/plugins/images/close-icon-white.png" width="30px" style="cursor: pointer" />
        </p>
        <div id="content">
            <img src="#" />
        </div>
    ...
    <script type="text/javascript" src="frontEnd/jsSQL/chatBoxSetter.js"></script>
    <script>
    ...
    <!--Style Switcher -->
    <script src="frontEnd/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
    <!--Style Switcher -->
    <!--ChatJs -->    
